...
function computeLifeScore(report) {
  ...
  const hoursPerYear = 365; // 1h/day in cold storage
...
// ============================================================================
function checkRequirements(report, config) {
...
// ============================================================================
// HELPERS — config path manipulation
// ============================================================================
...
function setNestedValue(obj, path, rawValue) {
  ...
  if (typeof existing === 'number') {
    ...
    // Allow setting null fields to strings
...
// Exports for testing
export { computeLifeScore, checkRequirements, DEFAULT_CONFIG, isTokenExpired, setNestedValue, getNestedValue, checkRequirements as _checkReq };
